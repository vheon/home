...
if !exists('g:rainbow_parenthesis_round')
    let g:rainbow_parenthesis_round = 1
endif

if !exists('g:rainbow_parenthesis_square')
    let g:rainbow_parenthesis_square = 0
endif

if !exists('g:rainbow_parenthesis_curly')
    let g:rainbow_parenthesis_curly = 0
endif
if !exists('g:rainbow_parenthesis_angle')
    let g:rainbow_parenthesis_angle = 0
endif
